import { faFileCircleCheck, faSackDollar, faStar, faStarAndCrescent, faUserFriends } from '@fortawesome/free-solid-svg-icons';
...
const Summary = () => {
    return (
        <div style={{fontFamily:"Aleo"}} className='my-14 bg-purple-100 rounded-xl px-10 py-6'>

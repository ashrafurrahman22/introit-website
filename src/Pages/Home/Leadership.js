...
const Leadership = () => {
    return (
        ...
        {/* image */}
        <div className="lg:grid grid-cols-3 gap-14 max-w-7xl mx-auto px-12">

        <div style={{fontFamily:"Aleo"}}>
        <img className='border rounded-xl w-3/4 mx-auto' src={leader2} alt="" />
        ...
        <div style={{fontFamily:"Aleo"}}>
        <img className='border rounded-xl w-3/4 mx-auto' src={leader1} alt="" />
        <div className='my-8 text-center'>
        ...
        <div style={{fontFamily:"Aleo"}}>
        <img className='border rounded-xl w-3/4 mx-auto' src={leader3} alt="" />
        <div className='my-8 text-center'>
